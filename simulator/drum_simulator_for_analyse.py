# python3
# -*- coding: utf-8 -*-
# @File    : drum_simulator_for_analyse.py
# @Desc    : 在同心鼓仿真器中收集数据，以备后期数据分析
# @Project : MCM-2019

"""
注意:
 - 本版本为主程序的一个分支，添加了一些冗余功能以便于收集产生的数据（分析不在本文件实现）
"""
...
class Drum:
    ...
    def save_some_data_for_plot(self):
        string = ""
        for ee in self.forcee:
            for i in ee:
                string += str(i) + ", "
        string += "\n"
        with open("./ee.csv", "a") as f:
            f.write(string)
